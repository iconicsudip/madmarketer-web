...
// Using high-quality unsplash placeholders to simulate the grid of images/videos
const slide1Images = [
  ...
  return (
    <section className={styles.heroSection}>
      ...
      <div className={styles.centerBlobContainer}>
        ...
        >
          {/* Subtle animated gradient inside blob */}
          <div className={styles.blobGlow}></div>
          
          <div className={styles.heroContent}>
            <h1 className={styles.heading}>Mad Marketer</h1>
            <p className={styles.subheading}>
              Create intelligent growth infrastructure for your business.
            </p>
      ...
      <div className={styles.bottomInterface}>
        <div className={styles.carouselControls}>
          <button className={styles.iconBtn} onClick={prevSlide}><ChevronLeft size={16} /></button>
          ...
          <button className={styles.iconBtn} onClick={nextSlide}><ChevronRight size={16} /></button>
        </div>
      </div>
    </section>
  );
